...
```bash
clj-nrepl-eval -p 7888 "(require '[ascolais.sfere :as sfere] :reload)"
```

Then call functions from it:

```bash
clj-nrepl-eval -p 7888 "(sfere/some-function arg1 arg2)"
```
...
```bash
clj-nrepl-eval -p 7888 "(require '[ascolais.sfere] :reload)"
```
...
clj-nrepl-eval -p 7888 "(require '[ascolais.sfere-test] :reload)"
clj-nrepl-eval -p 7888 "(run-tests 'ascolais.sfere-test)"
```
